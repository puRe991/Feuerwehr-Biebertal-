...
export const fahrzeuge: Fahrzeug[] = [
  { slug: 'hlf-20-mitte', funk: 'Florian Biebertal 1/46', standort: 'Schutzbereich Mitte', typ: 'Hilfeleistungslöschgruppenfahrzeug', einsatzzweck: 'Brandbekämpfung und technische Hilfeleistung', besatzung: 'Gruppe 1/8', besonderheiten: ['Wasserführend', 'Technische Hilfeleistung', 'Atemschutz'], bildAlt: 'Hilfeleistungslöschgruppenfahrzeug der Feuerwehr Biebertal' },
  ...
  { slug: 'mlf-west', funk: 'Florian Biebertal 3/40', standort: 'Schutzbereich West', typ: 'Mittleres Löschfahrzeug', einsatzzweck: 'Brandbekämpfung und Unterstützung im Schutzbereich', besatzung: 'Staffel 1/5', besonderheiten: ['Löschwasser', 'Atemschutz', 'Flexible Beladung'], bildAlt: 'Mittleres Löschfahrzeug der Feuerwehr Biebertal' },
