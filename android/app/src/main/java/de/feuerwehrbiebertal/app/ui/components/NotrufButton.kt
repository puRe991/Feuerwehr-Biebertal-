...
private val NotrufRedLight = Color(0xFFE5383B)
...
fun NotrufCard() {
    ...
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .background(
                brush = Brush.linearGradient(listOf(NotrufRedLight, BrandRed)),
        ...
        Button(
            ...
            Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                Text("112 anrufen", fontWeight = androidx.compose.ui.text.font.FontWeight.Bold)
            }
        }
    }
}
